...
public class Principal {
    ...
    public void muestraElMenu() {
        String menu = """
                --------------------------------------------
                \n Escoja una opción digitando el número:
                1 * Encontrar un libro por el titulo.
                2 * Mostrar todos los libros registrados.
                3 * Mostrar todos los autores registrados.
                4 * Encontrar los autores vivos en un determinado año.
                5 * Obtener libros por su idioma.
